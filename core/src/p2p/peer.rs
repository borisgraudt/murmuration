...
// PeerInfo, PeerMetrics and ConnectionState now live in the murmuration-routing
// crate; re-exported so `crate::p2p::peer::PeerInfo` paths keep working.
pub use murmuration_routing::peer::{ConnectionState, PeerInfo, PeerMetrics};
