#!/bin/bash
# Murmuration MVP Demo Script
# Launches 3 nodes and demonstrates AI-routing + PQC encryption

set -e

echo " Starting Murmuration MVP Demo..."
echo ""
...
MURMURATION_API_PORT=17082 cargo run --bin cli -- broadcast "Murmuration AI+PQC demo message" || true
