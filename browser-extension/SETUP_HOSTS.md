# Настройка кастомного домена mur.local

Чтобы использовать `mur.local` вместо `localhost` в адресной строке, нужно добавить запись в hosts файл.
...
Теперь вместо `http://localhost:17081/e/...` будет `http://mur.local:17081/e/...`
